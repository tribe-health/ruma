...
use ruma_common::{
    api::{
        ...
        AuthScheme, FromHttpBody, IncomingRequest, IncomingResponse, IntoHttpBody, MatrixVersion,
        Metadata, OutgoingRequest, OutgoingResponse, SendAccessToken, VersionHistory,
    },
...
impl IncomingRequest for Request {
    type IncomingBody = impl FromHttpBody<FromHttpRequestError>;
    type EndpointError = MatrixError;
...
impl IncomingResponse for Response {
    type IncomingBody = impl FromHttpBody<FromHttpResponseError<Self::EndpointError>>;
    type EndpointError = MatrixError;
